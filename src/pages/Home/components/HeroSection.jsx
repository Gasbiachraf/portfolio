                    ...
                    <div className='w-[80%] flex justify-between  max-[430px]:flex-col-reverse max-[430px]:items-center'>
                        <div  data-aos="fade-down-right"  data-aos-duration="1500" className=' flex flex-col justify-center w-[50%] max-[430px]:w-[95%] '>
                            ...
                            <div className='flex  max-[430px]:gap-0 max-[430px]:flex-col pr-16 max-[430px]:pr-0 pt-8  gap-10'>
                                ...
                                <button className='bg-[#a9cfd0] text-[#032a31] px-5 max-[430px]:w-[37vw] max-[430px]:justify-center max-[430px]:flex max-[430px]:jus py-2 max-[430px]:py-1 max-[430px]:px-2 rounded-full text-xl mt-4 flex items-center gap-2'><a download href={pdf}><b>Get CV</b></a> <MdOutlineFileDownload  className='text-2xl'/></button>
                            </div>
                        </div>
                        <div data-aos="fade-left"  data-aos-duration="1500" className='w-[35%] max-[430px]:w-[90%] '>
