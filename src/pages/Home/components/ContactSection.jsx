...
export const ContactSection = () => {
    ...
    return (
        <section name='contact' className="bg-[#032a31] text-[#a9cfd0] flex flex-col items-center ">
            ...
            <div className='flex justify-between items-center   max-[430px]:flex-col w-[80%] h-[80%] '>
                <img className='w-[40%]  max-[430px]:w-[100%] h-[100%]' src={contact} alt="" />
                <div className='w-[45%] max-[430px]:w-[100%] h-[100%] '>
